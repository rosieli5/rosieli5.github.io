...
I find that open enrollment reduces the housing price premium for high-quality neighborhood schools by over one third. Specifically, districts implementing open enrollment, relative to districts without open enrollment, experienced a 1.7 percentage-point decline in neighborhood school quality capitalization effects estimated at around 5% for one standard deviation of school quality in the initial period. I find that districts with open enrollment experienced a larger decline in the income gap between buyers on different sides of attendance boundaries. The findings additionally suggest evidence of increased economic integration across attendance boundaries.
